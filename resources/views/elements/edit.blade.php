        ...
        <form method="POST" action="/elements/{{$element->id}}">
            ...
            <div class="space-y-12">
              <div class="border-b border-gray-900/10 pb-12">
                <h2 class="text-base font-semibold leading-7 text-gray-900">Modifier un Element</h2>
...
{{-- ---------------- Arme------------- --}}
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
              <x-button href='/elements/{{$element->id}}' class="text-sm font-semibold leading-6 text-gray-900">Cancel</x-button>

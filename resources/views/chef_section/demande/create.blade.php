<x-layout>
  ...
  @endif
        ...
        <form method="POST" action="/chef_sections/{{$chef->id}}/demande/index">
                  ...
                  <div class="mt-3 col-auto">
                    ...
                    <div class="mt-2">
                      <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                        ...
                        <input type="text" name="titre" id="titre" autocomplete="titre"  class="form-control block flex-1 border-0 bg-transparent py-1.5 px-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="titre.. طلب إجازة" required value="{{ old('titre')}}">
                      </div>
                    </div>
  ...
  {{-- ------------------------avis_chef_unité  ------------------- --}}
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
              <button type="button" class=" btn btn-danger text-sm font-semibold leading-6 text-gray-900">Cancel</button>
